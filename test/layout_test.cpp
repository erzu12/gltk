...
class HirarchyNodeTest : public IHirarchyNode {
public:
    HirarchyNodeTest(Layout* layout) : layout(layout) {}
...
HirarchyNodeTest SetupNode(Layout *layout) {
    HirarchyNodeTest rootNode(layout);
    layout->setHirarchyNode(&rootNode);
    return rootNode;
}
...
TEST(LayoutTest, layoutTopLeftSquareAbsolute) {
    ...
    //auto rootNode = SetupNode(&rootLayout);
    HirarchyNodeTest rootNode(&rootLayout);
    rootLayout.setHirarchyNode(&rootNode);
    Layout layout(Anchors::TopLeft, MessureVec2(0, 0), Anchors::TopLeft, MessureVec2(100, 100));
...
//TEST(LayoutTest, layoutTopLeftRectangleAbsolute) {
    //Layout rootLayout(MessureVec2(200, 200));
    //Layout layout(Anchors::TopLeft, MessureVec2(0, 0), Anchors::TopLeft, MessureVec2(100, 200));
...
//TEST(LayoutTest, layoutTopLeftSquareRelative) {
    //Layout rootLayout(MessureVec2(200, 200));
    //Layout layout(Anchors::TopLeft, MessureVec2(0, 0), Anchors::TopLeft, MessureVec2(0.5, 0.5));
    //rootLayout.resolveTransform();
    //Mat3 transform = layout.getTransform();
    //std::cout << transform << std::endl;
    //ASSERT_FLOAT_EQ(transform[0][0], 100.0f);
...
//TEST(LayoutTest, layoutTopLeftRectangleRelative) {
    //Layout rootLayout(MessureVec2(200, 200));
    //Layout layout(Anchors::TopLeft, MessureVec2(0, 0), Anchors::TopLeft, MessureVec2(0.5, 1.0));
    //rootLayout.resolveTransform();
    //Mat3 transform = layout.getTransform();
    //std::cout << transform << std::endl;
    //ASSERT_FLOAT_EQ(transform[0][0], 100.0f);
...
//TEST(LayoutTest, layoutTopLeftSquareMixed) {
    //Layout rootLayout(MessureVec2(200, 200));
    //Layout layout(Anchors::TopLeft, MessureVec2(0, 0), Anchors::TopLeft, MessureVec2(100, .5));
    //rootLayout.resolveTransform();
    //Mat3 transform = layout.getTransform();
    //std::cout << transform << std::endl;
    //ASSERT_FLOAT_EQ(transform[0][0], 100.0f);
...
//TEST(LayoutTest, layoutInheritPositionAndSize) {
    //Layout rootLayout(MessureVec2(200, 200));
    //Layout layout(Anchors::BottomRight, MessureVec2(0, 0), Anchors::BottomRight, MessureVec2(.5, .5));
    //Layout childLayout(Anchors::BottomRight, MessureVec2(-10, -20), Anchors::BottomRight, MessureVec2(.5, .5));
    //rootLayout.resolveTransform();
